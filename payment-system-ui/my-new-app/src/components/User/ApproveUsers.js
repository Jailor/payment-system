...
function ApproveUsers() {
    ...
    const REDIRECT = 'http://localhost:3000/redirect/view-users';
    ...
    return (
        <div className="container">
            {(userData.operation.name === "CREATE" ||
                userData.operation.name === "REMOVE" ||
                userData.operation.name === "BLOCK" ||
                userData.operation.name === "UNBLOCK") &&
                <div>
                    ...
                    <p>
                        <strong>Status:</strong> {userData.status.name}
                    </p>
                    ...
                    <div>
                        <button onClick={handleApprove} className="button">
                            Approve {userData.operation.name}
                        </button>
                        <button onClick={handleReject} className="button">
                            Reject {userData.operation.name}
                        </button>
                    </div>
                </div>}
            {userData.operation.name === "MODIFY" && (
                <div>
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            ...
                            <p>
                                <strong>Status:</strong> {userData.newStatus.name}
                            </p>
                        </div>
                    </div>
                    <Alert color="danger" isOpen={show} toggle={onDismiss}>
