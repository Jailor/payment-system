        ...
        {users.map((object, index) => (
          <ul key={index} className="info">
            <div>
              ...
              {object.status.name !== 'REMOVED' && object.needsApproval === false && 
              ...
              {object.status.name === 'ACTIVE' && object.needsApproval === false && 
              ...
              {object.status.name === 'BLOCKED' && object.needsApproval === false && sessionStorage.getItem("rights").includes("UNBLOCK_USER") &&
              <button type="button" 
              className="link-button"
