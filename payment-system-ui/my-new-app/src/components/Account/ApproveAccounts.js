...
function ApproveAccounts() {
  ...
  return (
    <div>
      {(accountData.operation.name === "CREATE" ||
        accountData.operation.name === "REMOVE") && (
        <div>
          ...
          <p>
            <strong>Account Status:</strong> {accountData.accountStatus.name}
          </p>
          <p>
            <strong> Status: </strong> {accountData.status.name}
          </p>
          <div>
          ...
          <p> {"Error:\n" + errors} </p>
           ...
           <button onClick={handleApprove} className="link-button">
              Approve {accountData.operation.name}
            </button>
            <button onClick={handleReject} className="link-button">
              Reject {accountData.operation.name}
            </button>
          </div>
        </div>
      )}
      {accountData.operation.name === "MODIFY" && (
        <div>
          ...
          <div className="column">
            ...
            <p>
              ...
              {accountData.newAccountStatus.name}
            </p>
            <p>
              <strong> Status: </strong> {accountData.newStatus.name}
            </p>
          </div>
          <Alert color="danger" isOpen={show} toggle={onDismiss}>
          <p> {"Error:\n" + errors} </p>
