...
function ViewAccounts() {
  ...
  const REFRESH = "/redirect/view-accounts";
          ...
          <ul key={index} className="info">
            <div>
              <div className="list-container">
                ...
                <p>Status: {account.status.name}</p>
                <p>Account status: {account.accountStatus.name} </p>
              ...
              <div>
              {account.accountStatus.name !== "CLOSED" &&
              ...
              {account.accountStatus.name === "OPEN" &&
                account.needsApproval === false && (
                  <button
                    className="link-button"
                    onClick={() =>
              ...
              {(account.accountStatus.name === "OPEN" ||
                account.accountStatus.name === "BLOCKED_DEBIT") &&
                account.needsApproval === false && sessionStorage.getItem("rights").includes("MODIFY_ACCOUNT") &&(
                  <button
                    className="link-button"
                    onClick={() =>
              ...
              {(account.accountStatus.name === "OPEN" ||
                account.accountStatus.name === "BLOCKED_CREDIT") && sessionStorage.getItem("rights").includes("MODIFY_ACCOUNT") &&
                account.needsApproval === false && (
                  <button
                    className="link-button"
                    onClick={() =>
              ...
              {account.accountStatus.name === "BLOCKED" && sessionStorage.getItem("rights").includes("MODIFY_ACCOUNT") &&
                account.needsApproval === false && (
                  <button
                    className="link-button"
                    onClick={() =>
              ...
              {(account.accountStatus.name === "BLOCKED" ||
                account.accountStatus.name === "BLOCKED_CREDIT") &&
                account.needsApproval === false && sessionStorage.getItem("rights").includes("MODIFY_ACCOUNT") &&(
                  <button
                    className="link-button"
                    onClick={() =>
