...
function ApproveCustomers() {
  ...
  const REDIRECT = "http://localhost:3000/redirect/view-customers";
  ...
  return (
    <div className="container">
      {["CREATE", "REMOVE"].includes(customerData.operation.name) && (
        <div>
          <h2>Customer Information for operation {customerData.operation.name}</h2>
          <p>
          ...
          <p>
            <strong>Status:</strong> {customerData.status.name}
          </p>
          ...
          <div>
            <button onClick={handleApprove} className="button">
              Approve {customerData.operation.name}
            </button>
            <button onClick={handleReject} className="button">
              Reject {customerData.operation.name}
            </button>
          </div>
        </div>
      )}

      {customerData.operation.name === "MODIFY" && (
        <div>
          ...
          <div className="row">
            ...
            <div className="column">
              ...
              <p>
                <strong>Status:</strong> {customerData.newStatus.name}
              </p>
              <p>
