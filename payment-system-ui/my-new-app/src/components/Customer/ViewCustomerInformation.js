...
function ViewCustomerInformation(props) {
  ...
  return (
    <div className="container">
      ...
      <p><strong>Status:</strong> {customerObject.status.name}</p>
      ...
      <div>
        {customerObject.status.name !== "REMOVED" && customerObject.needsApproval === false && sessionStorage.getItem("rights").includes("REMOVE_ACCOUNT") &&(
